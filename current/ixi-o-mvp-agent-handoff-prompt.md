...
| 항목 | 경로 |
|---|---|
| 프로젝트 루트 (생성할 위치) | `/Users/bot_mandu/Documents/Phone-Claw/ixi-o-agent-memory/` |
| 기준 문서 (MVP 설계) | `/Users/bot_mandu/Documents/Phone-Claw/current/ixi-o-agent-memory-mvp.md` |
| 구현 계획서 | `/Users/bot_mandu/Documents/Phone-Claw/current/ixi-o-mvp-implementation-plan.md` |
| 아카이브 (읽지 마세요) | `/Users/bot_mandu/Documents/Phone-Claw/archive/` |

**중요**: 프로젝트 코드는 `/Users/bot_mandu/Documents/Phone-Claw/ixi-o-agent-memory/` 아래에 생성하세요. `archive/` 폴더의 과거 리서치 문서는 참고하지 마세요.
...
1. `/Users/bot_mandu/Documents/Phone-Claw/current/ixi-o-agent-memory-mvp.md` — 제품 설계, 스키마 정의, 저장 구조, MCP tool 명세, U+ API 대응 전략
2. `/Users/bot_mandu/Documents/Phone-Claw/current/ixi-o-mvp-implementation-plan.md` — 구현 계획서 (이 프롬프트의 상세 버전)
